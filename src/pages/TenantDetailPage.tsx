...
export default function TenantDetailPage({ id }: { id: number }) {
  ...
  const { data: historyData, loading: historyLoading } = useTenantHistory(id);
          ...
          <div className="mt-5 grid min-w-0 gap-5 xl:grid-cols-[minmax(0,1fr)_340px]">
            <div className="min-w-0 space-y-5">
              ...
              <section className="rounded-3xl border border-line bg-panel p-4 sm:p-5">
                <SectionHeading eyebrow="Profile" title="Contact details" />
                ...
                <div className="mt-5 grid grid-cols-1 gap-2.5 sm:grid-cols-2">
                  ...
                  <ContactCard icon={Mail} label="Email" value={tenant.email} />
              ...
              <section className="rounded-3xl border border-line bg-panel p-4 sm:p-5">
                <div className="flex items-end justify-between gap-3">
                  <SectionHeading eyebrow="Current" title="Active tenancies" />
              ...
              {/* Tenancy history */}
              <section className="rounded-3xl border border-line bg-panel p-4 sm:p-5">
                <SectionHeading eyebrow="Timeline" title="Tenancy history" />
            ...
            <aside className="min-w-0">
              <NotesPanel notableType="tenant" notableId={id} />
            </aside>
          </div>
        </>
      )}
...
function ContactCard({
  ...
  const iconClass =
    tone === "good" ? "bg-good-bg text-good-text" : "bg-page text-ink/55";
